...
public class HttpUtil {
    ...
    public static String post(String requestUrl, String accessToken, String params) throws Exception {
    	...
    	System.out.println("打开链接，开始发送请求" + System.currentTimeMillis()/1000);
        ...
        in.close();
        System.out.println("请求结束"+System.currentTimeMillis()/1000);
    ...
    public static String postVoice(String requestUrl,String params) throws Exception {
    	...
    	String filePath = path+"VOICE"+System.currentTimeMillis()/1000+".mp3";
    ...
    public static String postTest(String requestUrl,String params) throws Exception {
    	...
    	String filePath = path+"VOICE"+System.currentTimeMillis()/1000+".apk";
        String generalUrl = requestUrl;
        URL url = new URL(generalUrl);
        // 打开和URL之间的连接
        HttpURLConnection connection = (HttpURLConnection) url.openConnection();
